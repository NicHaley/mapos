            ...
            return (
              <Reorder.Item
                ...
                className={cn(
                  ...
                  "group relative inline-flex h-8 max-w-[160px] shrink-0 cursor-pointer items-center gap-1.5 rounded-lg border border-transparent bg-clip-padding pr-1 pl-2 text-[0.8rem] font-medium outline-none backdrop-blur-md select-none transition-colors",
