    ...
    <section className="bg-neutral-950 px-[clamp(20px,4vw,56px)] pt-20">
      <div className="mx-auto flex w-full max-w-[960px] flex-col gap-12">
        ...
        <div className="flex flex-col gap-4">
          <div className="mx-auto w-full max-w-[560px] overflow-hidden rounded-xl border border-neutral-800 bg-neutral-950/90">
            ...
            <div className="flex flex-col gap-1 px-4 py-4 font-[family-name:var(--font-server-mono)] text-[12.5px] leading-relaxed">
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="cursor-pointer rounded border border-neutral-800 p-1.5 text-neutral-400 transition-colors hover:border-neutral-600 hover:text-neutral-200"
                  onClick={copy}
                  type="button"
                >
                  {copied ? (
                    <LuCheck aria-hidden="true" size={13} />
                  ) : (
                    <LuCopy aria-hidden="true" size={13} />
                  )}
                </button>
              </div>
              {SKILLS.map((skill) => (
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {SKILLS.map((skill) => (
              <div
                className="flex flex-col gap-1.5 rounded-xl border border-neutral-800 bg-neutral-900/30 p-5"
                key={skill.name}
              >
