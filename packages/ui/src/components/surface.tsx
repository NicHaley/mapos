...
const surfaceVariants = cva("", {
  variants: {
    variant: {
      ...
      // Glass info pill over the map (coverage / status). Shape + padding at call site.
      pill: "flex items-center border border-border bg-background/80 shadow-sm backdrop-blur-md",
